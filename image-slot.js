...
(() => {
  ...
  const stylesheet =
    ...
    '  background:#fff;box-shadow:0 0 0 1.5px #8E2D44,0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px #8E2D44}' +
    ...
    ':host([data-over]) .frame{outline:2px solid #8E2D44;outline-offset:-2px;' +
    '  background:rgba(142,45,68,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(0,0,0,.25);' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:#8E2D44}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">o <u>busca un archivo</u></div></div>' +
